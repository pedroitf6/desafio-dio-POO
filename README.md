...
<p align="center"> O objetivo desse desafio foi colocar em prática umas das principais ferramentas da OO: <br>
...
<strong>	3.</strong> As CLASSES Curso, Mentoria e Devs também MODELADOS, ou seja, criar seus ATRIBUTOS E MÉTODOS <br> 
<strong>	4.</strong> Para que o código fique mais legível e de fácil manutenção, foi utilizado algumas ferramentas do PARADIGMA DE ORIENTAÇÃO A OBJETOS (POO): ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO <br>
<strong>	5.</strong> E para representar CLASSES que foram criadas e relacionadas, foram transfordas em OBJETOS<br>
</p>
...
<h1> Resumo feito pela plataforma DIO - Professora <a href="https://github.com/cami-la">Camila Cavalcante</h1>
